Create a page to display four different types of charts (pie, line,bar,and candlestick). The project was built using python django as the backend and sever part while the forntend was handle by NextJs. 
